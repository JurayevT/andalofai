...
<div class="container">
    <div class="jumbotron container-fluid mt-0 text-center bg-transparent">
        <h1 class="mb-4">Akademik litseyimizda mavjud ta'lim yo'nalishlari</h1>
    ...
    <div class="body-content">
        ...
        <h2 class="text-center my-2">AQXAI akademik litsey  "9-May Xotira va qadirlash kuni" dan lavha</h2>
        ...
        <h2 class="text-center my-2">AQXAI akademik litseyida "Andijon polkasi 100 yilligi" chellange holatida nishonlandi</h2>
        ...
        <h2 class="text-center my-2">Alisher Navoiy tavallud ayyomi munosabati bilan tayyorlandi</h2>
        ...
        <h2 class="text-center mt-5 my-2">Zahiriddin Muhammad Bobur tavallud ayyomi munosabati bilan tayyorlandi</h2>
