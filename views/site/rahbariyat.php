...
<section class="testimonial text-center text-primary">
    <h1 class="testimonial__title mb-5">Rahbariyat xodimlari</h1>
    <div class="owl-carousel owl-theme mt-2">
      <div class="testimonial__card">
        ...
        <p class="testimonial__content mx-auto">
            Andijon qishloq xo'jaligi va agrotexnologiyalari instituti qoshidagi  akademik litseyi direktori.
        </p>
      </div>
      <div class="testimonial__card">
        <div class="img-box">
        ...
        <p class="testimonial__content mx-auto">
          Andijon qishloq xo'jaligi va agrotexnologiyalari instituti qoshidagi akademik litseyining o'quv ishlar bo'yicha direktor o'rinbosari.
        </p>
      </div>
      <div class="testimonial__card">
        <div class="img-box">
        ...
        <p class="testimonial__content mx-auto">
          Andijon qishloq xo'jaligi va agrotexnologiyalar instituti qoshidagi akademik  litseyining ma'naviy-ma'rifiy ishlari bo'yicha direktor o'rinbosari.
        </p>
      </div>
      <div class="testimonial__card">
        <div class="img-box">
        ...
        <p class="testimonial__content mx-auto">
          Andijon qishloq xo'jaligi va agrotexnolgiyalar instituti qoshidagi akademik litseyi xodimlar bo'limi boshlig'i.
        </p>
      </div>
      <div class="testimonial__card">
        <div class="img-box">
      ...
      <div class="testimonial__card">
        ...
        <p class="testimonial__content mx-auto">
          Andijon qishloq xo'jaligi va agrotexnologiyalar instituti qoshidagi akademik litsey moliyaviy iqtisodiy ishlar bo'yicha direktor o'rinbosari.
        </p>
      </div>
      <div class="testimonial__card">
        <div class="img-box">
        ...
        <p class="testimonial__content mx-auto">
          Andijon qishloq xo'jaligi va agrogtexnologiyalari instituti qoshidagi  akademik litseyining bosh hisobchisi.
        </p>
      </div>
    </div>
  </section>